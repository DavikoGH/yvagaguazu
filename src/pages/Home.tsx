      ...
      <section className="py-24 px-6 relative bg-yvaga-dark text-yvaga-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          <div className="bg-yvaga-white text-yvaga-dark p-8 md:p-12 lg:p-16 rounded-[40px] shadow-2xl max-w-4xl w-full">
            ...
            <Link to="/contacto" className="bg-yvaga-sec text-yvaga-white hover:bg-yvaga-dark transition-colors px-10 py-5 rounded-full font-sans font-bold text-[18px] md:text-[20px] tracking-widest w-full md:w-auto inline-flex items-center justify-center gap-3 shadow-md uppercase">
      ...
      <section className="py-24 px-6 bg-yvaga-white">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start lg:gap-16 gap-12">
          ...
          <div className="w-full lg:w-[55%] flex flex-col justify-center">
            ...
            <div className="bg-white p-6 md:p-8 rounded-[24px] shadow-sm border border-yvaga-sec/5 mb-8">
              <p className="font-serif text-lg md:text-xl font-medium text-yvaga-sec mb-6 leading-relaxed">
              ...
              <ul className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  <li key={i} className="flex flex-col items-start p-4 bg-white rounded-xl shadow-sm border border-yvaga-sec/10">
                    <CheckCircle className="w-6 h-6 text-yvaga-sec mb-3" />
                    <span className="font-sans text-sm md:text-base font-bold text-yvaga-sec leading-tight mb-1">{item.title}</span>
                    <span className="font-sans text-xs text-yvaga-sec/70">{item.sub}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="flex flex-col items-start gap-4">
               <p className="font-sans text-yvaga-sec text-base md:text-lg font-medium">
                 Cuando visitas Yvaga Guazú, <span className="font-bold">formas parte de su protección.</span>
               </p>
               <button className="bg-yvaga-sec text-white px-8 py-4 rounded-full font-serif font-medium text-base md:text-lg hover:bg-yvaga-dark transition-colors w-full sm:w-auto shadow-sm">
          ...
          <div className="w-full lg:w-[40%] relative rounded-[32px] overflow-hidden flex flex-col justify-center p-8 md:p-10 shadow-lg border border-yvaga-sec/10">
            {/* Background Image */}
            <div className="absolute inset-0 z-0">
              <img 
